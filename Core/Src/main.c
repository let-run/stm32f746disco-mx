...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
//__attribute__ ((section(".buffer"), used)) uint8_t Tx_Buf[1024];

//LWIP_DECLARE_MEMORY_ALIGNED(Tx_Buf, 1024);
...
//		  */
  ...
  #define REFRESH_COUNT ((uint32_t)0x2573)
  ...
  memset(0xC0000000, 0x00, 3*1024*1024);
